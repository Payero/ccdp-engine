...
echo "Running CCPD from: $CCDP_BASE"


# CCDP Configuration directory
CCDP_CFG_DIR="$CCDP_BASE/config"

# CCDP Library directory
CCDP_LIB_DIR="$CCDP_BASE/lib"

# CCDP Classes directory
CCDP_CLS_DIR="$CCDP_BASE/classes"

# CCDP Log directory
CCDP_LOG_DIR="$CCDP_BASE/logs"

# location of the pid file
if [ -z "$CCDP_PIDFILE" ] ; then
	CCDP_PIDFILE="$CCDP_LOG_DIR/ccdp.pid"
fi
...
# If there is aclasses directory add it
