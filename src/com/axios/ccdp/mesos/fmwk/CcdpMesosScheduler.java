...
//      this.logger.warn("The Offer " + offer.toString() );
   ...
   * saying so, etc). If implicit acknowledgments are being used, then 
   ...
   * lost/fails during that time). If explicit acknowledgments are in use, the 
   ...
   */
       ...
       SlaveID slvId, byte[] data)
   {
     ...
     {
       this.logger.error("Error processing a frameworkMessage");
