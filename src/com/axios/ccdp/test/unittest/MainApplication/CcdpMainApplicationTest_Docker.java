...
public class CcdpMainApplicationTest_Docker implements CcdpMessageConsumerIntf
{
  ...
  private static Logger logger = Logger
      .getLogger(CcdpMainApplicationTest_Docker.class.getName());
  /**
  ...
  public CcdpMainApplicationTest_Docker()
  {
